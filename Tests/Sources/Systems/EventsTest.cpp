...
// CursorAreaEventsListener.OnDrawn* tests live in Rendered/EventsCursorAreaListenerTest.cpp
// — they require Integration::PreDrawFrame to push a current cursor-area layer, which
// only happens in the rendered tier.
