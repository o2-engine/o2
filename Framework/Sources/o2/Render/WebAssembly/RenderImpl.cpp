...
namespace o2
{
    ...
    // WebGL owns its context on the browser's main thread — rendering can only move off it through an
    // OffscreenCanvas in a worker, which the whole application loop would have to follow
