...
namespace o2
{
    ...
    float ShaderParamFloat::GetValue() const { return mValue; }
    void ShaderParamFloat::SetValue(float value) { mValue = value; }
    ...
    const Color4& ShaderParamColor::GetValue() const { return mValue; }
    void ShaderParamColor::SetValue(const Color4& value) { mValue = value; }
    ...
    int ShaderParamInt::GetValue() const { return mValue; }
    void ShaderParamInt::SetValue(int value) { mValue = value; }
    ...
    int Material::GetTransformUniform() const { return mTransformUniform; }
    int Material::GetTextureUniform() const { return mTextureUniform; }
    int Material::GetPositionAttribute() const { return mPositionAttribute; }
    int Material::GetColorAttribute() const { return mColorAttribute; }
    int Material::GetTexCoordsAttribute() const { return mTexCoordsAttribute; }
    ...
    void Material::PostRefConstruct()
    {}
