...
namespace o2
{
    ...
    template<typename T>
    static auto ConvertScriptArg(o2js_value_t* args, size_t index, int count)
    ...
    struct ScriptFunctionContainer : public ScriptValueBase::TPoolContainer<ScriptFunctionContainer<_invocable_type, _res_type, _args...>, ScriptValueBase::IFunctionContainer>
    {
        ...
        o2js_value_t Invoke(o2js_value_t thisValue, o2js_value_t* args, int argsCount) override
        {
            return InvokeImpl(args, argsCount, std::index_sequence_for<_args...>{});
        }

        template<size_t... Is>
        o2js_value_t InvokeImpl(o2js_value_t* args, int argsCount, std::index_sequence<Is...>)
        {
            ...
            else
            {
                ...
                return o2js_acquire(res.mValue);
            }
        }
    };
    ...
    struct ScriptThisFunctionContainer : public ScriptValueBase::TPoolContainer<ScriptThisFunctionContainer<_invocable_type, _res_type, _args...>, ScriptValueBase::IFunctionContainer>
    {
        ...
        template<size_t... Is>
        o2js_value_t InvokeImpl(ScriptValue& thisObj, o2js_value_t* args, int argsCount, std::index_sequence<Is...>)
        {
            if constexpr (std::is_void<_res_type>::value)
            {
    ...
    {
        template<size_t... Is>
        static o2js_value_t Invoke(_class* obj, const o2js_value_t* args, int count, std::index_sequence<Is...>)
        {
            Callable callable{};
            if constexpr (std::is_void_v<_res>)
            {
                callable(obj, ConvertScriptArg<_args>((o2js_value_t*)args, Is, count)...);
                return o2js_undefined();
            }
            else
            {
                ScriptValue res(callable(obj, ConvertScriptArg<_args>((o2js_value_t*)args, Is, count)...));
                return o2js_acquire(res.mValue);
            }
        }

        static o2js_value_t Handle(const o2js_value_t function_obj,
                                    ...
                                    const int args_count)
        {
            ...
            if (!container) return o2js_undefined();

            _class* thisObj = dynamic_cast<_class*>(container->TryCastToIObject());
            if (!thisObj) return o2js_undefined();
    ...
    struct PrototypeFieldGetter : public ScriptValueBase::TPoolContainer<PrototypeFieldGetter<_object_type, _field_type>, ScriptValueBase::IPrototypeGetter>
    {
        ...
        o2js_value_t GetFrom(o2js_value_t this_val) override
        {
            auto container = ScriptValueBase::GetNativeContainer(this_val);
            if (!container) return o2js_undefined();

            auto objectPtr = static_cast<_object_type*>(container->GetData());
            if (!objectPtr) return o2js_undefined();
            ...
            return o2js_acquire(tmp.mValue);
        }
    };
    ...
    struct PrototypeFieldSetter : public ScriptValueBase::TPoolContainer<PrototypeFieldSetter<_object_type, _field_type>, ScriptValueBase::IPrototypeSetter>
    {
        ...
        void SetTo(o2js_value_t this_val, o2js_value_t value) override
        {
            auto container = ScriptValueBase::GetNativeContainer(this_val);
            if (!container) return;
    ...
    template<typename _type>
    o2js_value_t ScriptValueBase::PointerGetterWrapperContainer<_type>::Get()
    {
        ScriptValue tmp;
    ...
    template<typename _type>
    void ScriptValueBase::PointerSetterWrapperContainer<_type>::Set(o2js_value_t value)
    {
        ScriptValue tmp;
        tmp.AcquireValue(value);
    ...
    o2js_value_t ScriptValueBase::PropertyGetterWrapperContainer<_property_type>::Get()
    {
        ScriptValue tmp;
    ...
    template<typename _property_type>
    void ScriptValueBase::PropertySetterWrapperContainer<_property_type>::Set(o2js_value_t value)
    {
        ScriptValue tmp;
        tmp.AcquireValue(value);
    ...
    template<typename _type>
    o2js_value_t ScriptValueBase::FunctionalGetterWrapperContainer<_type>::Get()
    {
        ScriptValue tmp;
    ...
    template<typename _type>
    void ScriptValueBase::FunctionalSetterWrapperContainer<_type>::Set(o2js_value_t value)
    {
        ScriptValue tmp;
        tmp.AcquireValue(value);
    ...
    void ScriptValue::SetContainingObject(_type* object)
    {
        ...
        if constexpr (HasRefCounterMethod<_type>::value)
        {
            ...
            o2js_set_native_pointer(mValue, (IDataContainer*)dataContainer, &FreeDataContainer);
        }
    ...
    void ScriptValue::SetPropertyWrapper(const ScriptValue& name, _type& value)
    {
        ...
        getterFunc.Accept(o2js_external_function(DescriptorGetter));
        ...
        if constexpr (IsProperty<_type>::value)
        {
            ...
            o2js_set_native_pointer(getterFunc.mValue, getterWrapperContainer, &FreeDataContainer);
        }
        else
        {
        ...
        setterFunc.Accept(o2js_external_function(DescriptorSetter));

        if constexpr (IsProperty<_type>::value)
        {
            auto setterWrapperContainer = CreateContainer<PropertySetterWrapperContainer<_type>>();
            setterWrapperContainer->propertyPtr = &value;
            o2js_set_native_pointer(setterFunc.mValue, setterWrapperContainer, &FreeDataContainer);
        }
        else
        {
        ...
        o2js_release(o2js_define_accessor(mValue, name.mValue, getterFunc.mValue, setterFunc.mValue));
    }
    ...
    void ScriptValue::SetPrototypePropertyWrapper(const ScriptValue& name, void* (*pointerGetter)(void*))
    {
        ...
        ScriptValue getterFunc;
        getterFunc.Accept(o2js_external_function(PrototypeDescriptorGetter));
        ...
        o2js_set_native_pointer(getterFunc.mValue, getterContainer, &FreeDataContainer);

        ScriptValue setterFunc;
        setterFunc.Accept(o2js_external_function(PrototypeDescriptorSetter));
        ...
        o2js_set_native_pointer(setterFunc.mValue, setterContainer, &FreeDataContainer);
    ...
    void ScriptPrototypeProcessor::FunctionProcessor::Signature(_object_type* object, Type* type, const char* name, _callable /*callable*/)
    {
        ...
        ScriptValue funcVal;
        funcVal.Accept(o2js_external_function(&ThunkMethodHandler<_callable, PMF>::Handle));
