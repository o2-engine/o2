...
namespace o2
{
    ...
    // ---------------------------------------------------------
    // Base wrapper around browser JS value handle and native bindings
    // ---------------------------------------------------------
    class ScriptValueBase
    {
    public:
        // Stored value handle.
        mutable o2js_value_t mValue;

    public:
        // Releases stored value handle.
        virtual ~ScriptValueBase();

        // Acquires passed value handle and releases current one.
        void AcquireValue(o2js_value_t v);

        // Accepts ownership of passed value handle and releases current one.
        void Accept(o2js_value_t v);
    ...
    public:
        ...
        struct IFunctionContainer : public IDataContainer
        {
            ...
            virtual o2js_value_t Invoke(o2js_value_t thisValue, o2js_value_t* args, int argsCount) = 0;
        };
        ...
        struct ISetterWrapperContainer : public IDataContainer
        {
            ...
            virtual void Set(o2js_value_t value) = 0;
        };
        ...
        {
            // Reads wrapped value and converts it to script value handle.
            virtual o2js_value_t Get() = 0;
        };
        ...
        struct IPrototypeGetter : public IDataContainer
        {
            ...
            virtual o2js_value_t GetFrom(o2js_value_t this_val) = 0;
        };
        ...
        struct IPrototypeSetter : public IDataContainer
        {
            ...
            virtual void SetTo(o2js_value_t this_val, o2js_value_t value) = 0;
        };
        ...
        struct PointerSetterWrapperContainer : public TPoolContainer<PointerSetterWrapperContainer<_type>, ISetterWrapperContainer>
        {
            ...
            void Set(o2js_value_t value) override;
        };
        ...
        static IDataContainer* GetNativeContainer(o2js_value_t jval);
    ...
    protected:
        ...
        static o2js_value_t CallFunction(const o2js_value_t function_obj,
                                          const o2js_value_t this_val,
                                          const o2js_value_t args_p[],
                                          const int args_count);

        // Engine callback for property setter wrappers.
        static o2js_value_t DescriptorSetter(const o2js_value_t function_obj,
                                              const o2js_value_t this_val,
                                              const o2js_value_t args_p[],
                                              const int args_count);

        // Engine callback for property getter wrappers.
        static o2js_value_t DescriptorGetter(const o2js_value_t function_obj,
                                              const o2js_value_t this_val,
                                              const o2js_value_t args_p[],
                                              const int args_count);

        // Engine callback for prototype property getters.
        static o2js_value_t PrototypeDescriptorGetter(const o2js_value_t function_obj,
                                                       const o2js_value_t this_val,
                                                       const o2js_value_t args_p[],
                                                       const int args_count);

        // Engine callback for prototype property setters.
        static o2js_value_t PrototypeDescriptorSetter(const o2js_value_t function_obj,
                                                       const o2js_value_t this_val,
                                                       const o2js_value_t args_p[],
                                                       const int args_count);
