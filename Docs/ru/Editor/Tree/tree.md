...
Имена объектов прототипа выделяются цветом. Все объекты одного экземпляра прототипа окрашены одинаково; прототип, вложенный в другой прототип, получает следующий цвет, так что вложенность видна сразу. Цвета повторяются по кругу с ростом глубины вложенности.
