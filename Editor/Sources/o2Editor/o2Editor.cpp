...
extern void __RegisterEnum__Editor__PipelineNodeCategory();
...
extern void __RegisterEnum__Editor__SceneDragHandle3D__PickShape__Type();
...
extern void __RegisterClass__Editor__BreakPrototypeAction();
extern void __RegisterClass__Editor__BreakPrototypeAction__ActorInfo();
extern void __RegisterClass__Editor__CopyAssetsAction();
extern void __RegisterClass__Editor__CopyAssetsAction__Entry();
extern void __RegisterClass__Editor__CreateAction();
extern void __RegisterClass__Editor__CreateAssetAction();
extern void __RegisterClass__Editor__CreateAssetFromSceneAction();
extern void __RegisterClass__Editor__CreateAssetFromSceneAction__Entry();
extern void __RegisterClass__Editor__DeleteAction();
extern void __RegisterClass__Editor__DeleteAction__ObjectInfo();
extern void __RegisterClass__Editor__DeleteAssetAction();
extern void __RegisterClass__Editor__DeleteAssetAction__Entry();
extern void __RegisterClass__Editor__DepthInheritAction();
extern void __RegisterClass__Editor__EnableAction();
extern void __RegisterClass__Editor__IAction();
extern void __RegisterClass__Editor__LayerCreateAction();
extern void __RegisterClass__Editor__LayerDeleteAction();
extern void __RegisterClass__Editor__LayerRenameAction();
extern void __RegisterClass__Editor__LayerReorderAction();
extern void __RegisterClass__Editor__LayerVisibilityAction();
extern void __RegisterClass__Editor__LockAction();
extern void __RegisterClass__Editor__MeshPointsAction();
extern void __RegisterClass__Editor__MoveAssetAction();
extern void __RegisterClass__Editor__MoveAssetAction__Entry();
extern void __RegisterClass__Editor__PropertyChangeAction();
extern void __RegisterClass__Editor__RemoveComponentAction();
extern void __RegisterClass__Editor__RemoveComponentAction__ComponentInfo();
extern void __RegisterClass__Editor__RenameAssetAction();
extern void __RegisterClass__Editor__ReparentAction();
extern void __RegisterClass__Editor__RevertToPrototypeAction();
extern void __RegisterClass__Editor__RevertToPrototypeAction__ActorInfo();
...
extern void __RegisterClass__Editor__PipelinePort();
extern void __RegisterClass__Editor__PipelineNode();
extern void __RegisterClass__Editor__PipelineEdge();
extern void __RegisterClass__Editor__PipelineGraph();
...
extern void __RegisterClass__Editor__Vec3FProperty();
...
extern void __RegisterClass__Editor__PipelineComposerStage();
extern void __RegisterClass__Editor__PipelineRoundedRect();
extern void __RegisterClass__Editor__PipelinePortMarker();
extern void __RegisterClass__Editor__PipelineWrapRow();
extern void __RegisterClass__Editor__PipelineSlider();
extern void __RegisterClass__Editor__PipelineImageView();
extern void __RegisterClass__Editor__PipelineTextView();
extern void __RegisterClass__Editor__PipelineColorField();
extern void __RegisterClass__Editor__PipelineGraphAction();
extern void __RegisterClass__Editor__PipelineEditor();
extern void __RegisterClass__Editor__PipelineMediaControls();
extern void __RegisterClass__Editor__PipelineAudioView();
extern void __RegisterClass__Editor__PipelineVideoView();
extern void __RegisterClass__Editor__PipelineNodeBody();
extern void __RegisterClass__Editor__PipelineCropEditor();
extern void __RegisterClass__Editor__PipelineNodePalette();
extern void __RegisterClass__Editor__PipelineNodeWidget();
extern void __RegisterClass__Editor__PipelinePaintEditor();
extern void __RegisterClass__Editor__PipelineWindow();
...
extern void __RegisterClass__Editor__SceneDragHandle3D();
...
extern void InitializeTypeso2Editor()
{
    ...
    __RegisterEnum__Editor__PipelineNodeCategory();
    ...
    __RegisterEnum__Editor__SceneDragHandle3D__PickShape__Type();
    ...
    __RegisterClass__Editor__BreakPrototypeAction();
    __RegisterClass__Editor__BreakPrototypeAction__ActorInfo();
    __RegisterClass__Editor__CopyAssetsAction();
    __RegisterClass__Editor__CopyAssetsAction__Entry();
    __RegisterClass__Editor__CreateAction();
    __RegisterClass__Editor__CreateAssetAction();
    __RegisterClass__Editor__CreateAssetFromSceneAction();
    __RegisterClass__Editor__CreateAssetFromSceneAction__Entry();
    __RegisterClass__Editor__DeleteAction();
    __RegisterClass__Editor__DeleteAction__ObjectInfo();
    __RegisterClass__Editor__DeleteAssetAction();
    __RegisterClass__Editor__DeleteAssetAction__Entry();
    __RegisterClass__Editor__DepthInheritAction();
    __RegisterClass__Editor__EnableAction();
    __RegisterClass__Editor__IAction();
    __RegisterClass__Editor__LayerCreateAction();
    __RegisterClass__Editor__LayerDeleteAction();
    __RegisterClass__Editor__LayerRenameAction();
    __RegisterClass__Editor__LayerReorderAction();
    __RegisterClass__Editor__LayerVisibilityAction();
    __RegisterClass__Editor__LockAction();
    __RegisterClass__Editor__MeshPointsAction();
    __RegisterClass__Editor__MoveAssetAction();
    __RegisterClass__Editor__MoveAssetAction__Entry();
    __RegisterClass__Editor__PropertyChangeAction();
    __RegisterClass__Editor__RemoveComponentAction();
    __RegisterClass__Editor__RemoveComponentAction__ComponentInfo();
    __RegisterClass__Editor__RenameAssetAction();
    __RegisterClass__Editor__ReparentAction();
    __RegisterClass__Editor__RevertToPrototypeAction();
    __RegisterClass__Editor__RevertToPrototypeAction__ActorInfo();
    ...
    __RegisterClass__Editor__PipelinePort();
    __RegisterClass__Editor__PipelineNode();
    __RegisterClass__Editor__PipelineEdge();
    __RegisterClass__Editor__PipelineGraph();
    ...
    __RegisterClass__Editor__Vec3FProperty();
    ...
    __RegisterClass__Editor__PipelineComposerStage();
    __RegisterClass__Editor__PipelineRoundedRect();
    __RegisterClass__Editor__PipelinePortMarker();
    __RegisterClass__Editor__PipelineWrapRow();
    __RegisterClass__Editor__PipelineSlider();
    __RegisterClass__Editor__PipelineImageView();
    __RegisterClass__Editor__PipelineTextView();
    __RegisterClass__Editor__PipelineColorField();
    __RegisterClass__Editor__PipelineGraphAction();
    __RegisterClass__Editor__PipelineEditor();
    __RegisterClass__Editor__PipelineMediaControls();
    __RegisterClass__Editor__PipelineAudioView();
    __RegisterClass__Editor__PipelineVideoView();
    __RegisterClass__Editor__PipelineNodeBody();
    __RegisterClass__Editor__PipelineCropEditor();
    __RegisterClass__Editor__PipelineNodePalette();
    __RegisterClass__Editor__PipelineNodeWidget();
    __RegisterClass__Editor__PipelinePaintEditor();
    __RegisterClass__Editor__PipelineWindow();
    ...
    __RegisterClass__Editor__SceneDragHandle3D();
